% (HARMONY) (2019) percussion ii part
% part_identifier = 'PERC2'
...
\score {
    <<
        ...
        \keepWithTag PercussionII {
            ...
            \include "../_segments/segment-17.ly"
            \include "../_segments/segment-18.ly"
            \include "../_segments/segment-19.ly"
            \include "../_segments/segment-20.ly"
            \include "../_segments/segment-21.ly"
            \include "../_segments/segment-22.ly"
            \include "../_segments/segment-23.ly"
            \include "../_segments/segment-24.ly"
            \include "../_segments/segment-25.ly"
            \include "../_segments/segment-26.ly"
            \include "../_segments/segment-27.ly"
            \include "../_segments/segment-28.ly"
            \include "../_segments/segment-29.ly"
        }
    >>
}
