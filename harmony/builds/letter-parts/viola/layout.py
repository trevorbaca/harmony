...
def main():
    ...
    layout = baca.make_layout(
        ...
        baca.page(
            ...
            baca.system(measure=35, y_offset=y_offset_3, distances=distances),
        ...
        baca.page(
            ...
            baca.system(measure=266, y_offset=y_offset_6, distances=distances),
        ),
        spacing=(1, 32),
        overrides=(
            baca.region(35, (1, 16)),
            baca.region(empty_measures, (1, 4)),
        ),
    )
