...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.1.BassFlute.Music.count.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.1.BassFlute.Music.count.2 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.1.BassFlute.Music.count.3 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.1.BassFlute.Music.count.4 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% \once \override Staff.Clef.extra-offset = #'(-2.5 . 0)
    ...
    <<
        ...
        \context Voice = "BassFlute.Music"
          %! baca.path.extern()
        { \number.1.BassFlute.Music.count.1 }
        % CLOSING:
        % COMMANDS:
    ...
    <<
        ...
        \context Voice = "BassFlute.Music"
          %! baca.path.extern()
        { \number.1.BassFlute.Music.count.2 }
        % CLOSING:
        % COMMANDS:
    ...
    <<
        ...
        \context Voice = "BassFlute.Music"
          %! baca.path.extern()
        { \number.1.BassFlute.Music.count.3 }
        % CLOSING:
        % COMMANDS:
    ...
    <<
        ...
        \context Voice = "BassFlute.Music"
          %! baca.path.extern()
        { \number.1.BassFlute.Music.count.4 }
        % CLOSING:
        % COMMANDS:
