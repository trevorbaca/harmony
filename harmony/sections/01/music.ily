...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.1.Bass_Flute.Music.count.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.1.Bass_Flute.Music.count.2 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.1.Bass_Flute.Music.count.3 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.1.Bass_Flute.Music.count.4 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% \once \override Staff.Clef.extra-offset = #'(-2.5 . 0)
    ...
    %@% ^ \baca-explicit-instrument-markup "(“BassFlute”)"
      ...
      %! baca._attach_latent_indicator_alert()
    %@% ^ \baca-explicit-short-instrument-name-markup "[“Bfl.”]"
    % ABSOLUTE_AFTER:
    % COMMANDS:
    ...
    <<
        ...
        \context Voice = "Bass_Flute.Music"
          %! baca.path.extern()
        { \number.1.Bass_Flute.Music.count.1 }
        % CLOSING:
        % COMMANDS:
    ...
    <<
        ...
        \context Voice = "Bass_Flute.Music"
          %! baca.path.extern()
        { \number.1.Bass_Flute.Music.count.2 }
        % CLOSING:
        % COMMANDS:
    ...
    <<
        ...
        \context Voice = "Bass_Flute.Music"
          %! baca.path.extern()
        { \number.1.Bass_Flute.Music.count.3 }
        % CLOSING:
        % COMMANDS:
    ...
    <<
        ...
        \context Voice = "Bass_Flute.Music"
          %! baca.path.extern()
        { \number.1.Bass_Flute.Music.count.4 }
        % CLOSING:
        % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.1.Bass_Flute.Music_Staff = <<
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% \once \override Staff.Clef.extra-offset = #'(-2.5 . 0)
    ...
    %@% ^ \baca-explicit-instrument-markup "(“Percussion”)"
      %! EXPLICIT_SHORT_INSTRUMENT_NAME_ALERT
      %! baca._attach_latent_indicator_alert()
    %@% ^ \baca-explicit-short-instrument-name-markup "[“Perc. I”]"
    % ABSOLUTE_AFTER:
    % COMMANDS:
      %! EXPLICIT_CLEF_REDRAW_COLOR
      %! baca._attach_color_literal(2)
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.1.Percussion.1.Music_Staff = <<
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% \once \override Staff.Clef.extra-offset = #'(-2.5 . 0)
    ...
    %@% ^ \baca-explicit-instrument-markup "(“Percussion”)"
      %! EXPLICIT_SHORT_INSTRUMENT_NAME_ALERT
      %! baca._attach_latent_indicator_alert()
    %@% ^ \baca-explicit-short-instrument-name-markup "[“Perc. II”]"
    % ABSOLUTE_AFTER:
    % COMMANDS:
      %! EXPLICIT_CLEF_REDRAW_COLOR
      %! baca._attach_color_literal(2)
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.1.Percussion.2.Music_Staff = <<
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% \once \override Staff.Clef.extra-offset = #'(-2.75 . 0)
    ...
    %@% ^ \baca-explicit-instrument-markup "(“Cello”)"
      %! EXPLICIT_SHORT_INSTRUMENT_NAME_ALERT
      %! baca._attach_latent_indicator_alert()
    %@% ^ \baca-explicit-short-instrument-name-markup "[“Vc. I”]"
    % SPANNER_STARTS:
      %! EXPLICIT_DYNAMIC_COLOR
      %! baca.treat_persistent_wrapper()
      %! EXPLICIT_DYNAMIC
...
%%% \once \override Staff.Clef.extra-offset = #'(-2.75 . 0)
    ...
    %@% ^ \baca-explicit-instrument-markup "(“Cello”)"
      %! EXPLICIT_SHORT_INSTRUMENT_NAME_ALERT
      %! baca._attach_latent_indicator_alert()
    %@% ^ \baca-explicit-short-instrument-name-markup "[“Vc. II”]"
    % ABSOLUTE_AFTER:
    % COMMANDS:
      %! EXPLICIT_CLEF_REDRAW_COLOR
      %! baca._attach_color_literal(2)
...
%%% \once \override Staff.Clef.extra-offset = #'(-2.75 . 0)
    ...
    %@% ^ \baca-explicit-instrument-markup "(“Contrabass”)"
      %! EXPLICIT_SHORT_INSTRUMENT_NAME_ALERT
      %! baca._attach_latent_indicator_alert()
    %@% ^ \baca-explicit-short-instrument-name-markup "[“Cb. I”]"
    % SPANNER_STARTS:
      %! EXPLICIT_DYNAMIC_COLOR
      %! baca.treat_persistent_wrapper()
      %! EXPLICIT_DYNAMIC
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.1.Contrabass.1.Music_Staff = <<
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% \once \override Staff.Clef.extra-offset = #'(-2.75 . 0)
    ...
    %@% ^ \baca-explicit-instrument-markup "(“Contrabass”)"
      %! EXPLICIT_SHORT_INSTRUMENT_NAME_ALERT
      %! baca._attach_latent_indicator_alert()
    %@% ^ \baca-explicit-short-instrument-name-markup "[“Cb. II”]"
    % ABSOLUTE_AFTER:
    % COMMANDS:
      %! EXPLICIT_CLEF_REDRAW_COLOR
      %! baca._attach_color_literal(2)
