            ...
            <<
                ...
                <<
                    ...
                    \context Staff = "Bass_Flute.Music_Staff"
                      %! harmony.make_empty_score()
                      %! baca.path.extern()
                    { \number.2.Bass_Flute.Music_Staff }
                    % CLOSING:
                    % COMMANDS:
                ...
                <<
                    ...
                    \context Staff = "Percussion.1.Music_Staff"
                      %! harmony.make_empty_score()
                      %! baca.path.extern()
                    { \number.2.Percussion.1.Music_Staff }
                    % ABSOLUTE_BEFORE:
                    % COMMANDS:
                    ...
                    \context Staff = "Percussion.2.Music_Staff"
                      %! harmony.make_empty_score()
                      %! baca.path.extern()
                    { \number.2.Percussion.2.Music_Staff }
                    % ABSOLUTE_BEFORE:
                    % COMMANDS:
                ...
                <<
                    ...
                    \context Staff = "Contrabass.1.Music_Staff"
                      %! harmony.make_empty_score()
                      %! baca.path.extern()
                    { \number.2.Contrabass.1.Music_Staff }
                    % ABSOLUTE_BEFORE:
                    % COMMANDS:
                    ...
                    \context Staff = "Contrabass.2.Music_Staff"
                      %! harmony.make_empty_score()
                      %! baca.path.extern()
                    { \number.2.Contrabass.2.Music_Staff }
                    % CLOSING:
                    % COMMANDS:
