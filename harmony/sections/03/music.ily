...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.3.Bass_Flute.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.3.Percussion.1.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% { \number.3.GlobalRests }
    ...
    \context Voice = "Percussion.1.MusicVoice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.3.Percussion.1.MusicVoice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.3.Percussion.2.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% { \number.3.GlobalRests }
    ...
    \context Voice = "Percussion.2.MusicVoice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.3.Percussion.2.MusicVoice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.3.Contrabass.1.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% { \number.3.GlobalRests }
    ...
    \context Voice = "Contrabass.1.MusicVoice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.3.Contrabass.1.MusicVoice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.3.Contrabass.2.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% { \number.3.GlobalRests }
    ...
    \context Voice = "Contrabass.2.MusicVoice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.3.Contrabass.2.MusicVoice }
    % CLOSING:
    % COMMANDS:
