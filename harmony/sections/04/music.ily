...
>>
  ...
  %! baca.path.extern()
number.4.Percussion.1.Music.count.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.4.Percussion.1.Music = {
    ...
    <<
        ...
        \context Voice = "Percussion.1.Music"
          %! baca.path.extern()
        { \number.4.Percussion.1.Music.count.1 }
        % CLOSING:
        % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.4.Cello.1.Music.count.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.4.Cello.2.Music.count.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.4.Contrabass.1.Music.count.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% \once \override Staff.Clef.extra-offset = #'(-2.5 . 0)
    ...
    <<
        ...
        \context Voice = "Contrabass.1.Music"
          %! baca.path.extern()
        { \number.4.Contrabass.1.Music.count.1 }
        % CLOSING:
        % COMMANDS:
