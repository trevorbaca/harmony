...
music = library.make_tessera_1(5, function=commands.get(3))
voice.extend(music)
...
music = library.make_tessera_1(1, function=commands.get(3))
voice.extend(music)
...
music = library.make_tessera_1(0, function=commands.get(3))
voice.extend(music)
