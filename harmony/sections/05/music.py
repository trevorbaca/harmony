...
def vc1(m):
    ...
    with baca.scope(m.get(4, 5)) as o:
        ...
        baca.dls_staff_padding(baca.select.lleak(o.leaves()), 5.5)
...
def cb2(m):
    with baca.scope(m[1]) as o:
        ...
        baca.hairpin(o, "o< f", left_broken=True)
        baca.scp_spanner(
            o.leaves(),
            "(T1) -> P2 -> O",
            abjad.Tweak(r"- \tweak staff-padding 5.5"),
