...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.7.Bass_Flute.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.7.Percussion.1.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% { \number.7.GlobalRests }
    ...
    \context Voice = "Percussion.1.MusicVoice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.7.Percussion.1.MusicVoice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.7.Percussion.2.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% { \number.7.GlobalRests }
    ...
    \context Voice = "Percussion.2.MusicVoice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.7.Percussion.2.MusicVoice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.7.Viola.MusicVoice.count.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.7.Viola.MusicVoice.count.2 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.7.Viola.MusicVoice = {
    ...
    <<
        ...
        \context Voice = "Viola.MusicVoice"
          %! baca.path.extern()
        { \number.7.Viola.MusicVoice.count.1 }
        % CLOSING:
        % COMMANDS:
    ...
    <<
        ...
        \context Voice = "Viola.MusicVoice"
          %! baca.path.extern()
        { \number.7.Viola.MusicVoice.count.2 }
        % CLOSING:
        % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.7.Cello.1.MusicVoice.count.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.7.Cello.1.MusicVoice = {
    ...
    <<
        ...
        \context Voice = "Cello.1.MusicVoice"
          %! baca.path.extern()
        { \number.7.Cello.1.MusicVoice.count.1 }
        % CLOSING:
        % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.7.Contrabass.1.MusicVoice.count.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.7.Contrabass.1.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    <<
        ...
        \context Voice = "Contrabass.1.MusicVoice"
          %! baca.path.extern()
        { \number.7.Contrabass.1.MusicVoice.count.1 }
        % CLOSING:
        % COMMANDS:
...
%%% { \number.7.GlobalRests }
    ...
    \context Voice = "Contrabass.1.MusicVoice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.7.Contrabass.1.MusicVoice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.7.Contrabass.2.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% { \number.7.GlobalRests }
    ...
    \context Voice = "Contrabass.2.MusicVoice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.7.Contrabass.2.MusicVoice }
    % CLOSING:
    % COMMANDS:
