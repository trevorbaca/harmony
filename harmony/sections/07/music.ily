...
>>
  ...
  %! baca.path.extern()
number.7.Cello.1.Music.count.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.7.Contrabass.1.Music.count.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.7.Contrabass.1.Music = {
    ...
    <<
        ...
        \context Voice = "Contrabass.1.Music"
          %! baca.path.extern()
        { \number.7.Contrabass.1.Music.count.1 }
        % CLOSING:
        % COMMANDS:
