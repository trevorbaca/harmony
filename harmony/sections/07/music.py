...
def BFL(voice, measures):
    ...
    def preprocessor(durations):
        ...
        result = baca.sequence.split(result, [(7, 8), (5, 8)])
        return result
...
def PERC2(voice, measures):
    ...
    music = baca.make_mmrests(measures(3))
    voice.extend(music)
    music = baca.make_notes(measures(4, 5))
    voice.extend(music)
    music = library.make_sixteenths(
        measures(6),
        [16, "-", 1],
...
def HP(voice, measures):
    ...
    def preprocessor(durations):
        result = baca.sequence.fuse(durations)
        result = baca.sequence.split(result, [(1, 4), (2, 4), (1, 8), (5, 8)])
        return result
...
def VC2(voice, measures):
    ...
    voice.extend(music)
    music = baca.make_repeat_tied_notes(measures(8))
    voice.extend(music)
    baca.section.append_anchor_note(voice)
