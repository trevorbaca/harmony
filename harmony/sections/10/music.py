...
def PERC1(voice, signatures):
    ...
    voice.extend(music)
    music = baca.make_notes(signatures(10, 14))
    voice.extend(music)
    music = baca.make_mmrests(signatures(15), head=voice.name)
    voice.extend(music)


def PERC2(voice, signatures):
    music = baca.make_notes(signatures(1, 7))
    voice.extend(music)
    music = baca.make_mmrests(signatures(8, 9))
    voice.extend(music)
    music = baca.make_notes(signatures(10, 15))
    voice.extend(music)
    baca.section.append_anchor_note(voice)
...
def HP(voice, signatures):
    music = baca.make_mmrests(signatures(1))
    voice.extend(music)
    music = baca.make_notes(signatures(2, 8))
    voice.extend(music)
    music = baca.make_mmrests(signatures(9))
    voice.extend(music)
    music = baca.make_notes(signatures(10, 12))
    voice.extend(music)
...
def VA(voice, signatures):
    ...
    voice.extend(music)
    music = baca.make_notes(signatures(15))
    voice.extend(music)
    baca.section.append_anchor_note(voice)
...
def bfl(cache):
    ...
    with baca.scope(m[14]) as o:
        baca.hairpin(
            o,
            "o< mp >o niente",
            the_pieces=baca.select.lparts(o, [1, 3]),
        )
...
def va(m):
    ...
    with baca.scope(m.get(10, 15)) as o:
        ...
        baca.hairpin(
            o.rleaves(),
            "o< ff >o niente",
            the_pieces=baca.select.mgroups(o.rleaves(), [3, 4]),
            right_broken=True,
        )
        baca.scp_spanner(
            o.leaves(),
            ...
            bookend=-1,
            the_pieces=baca.select.mgroups(o.leaves(), [3, 3]),
        )
...
def cb1(m):
    ...
    with baca.scope(m.get(2, 12)) as o:
        ...
        baca.scp_spanner(
            ...
            abjad.Tweak(r"- \tweak staff-padding 3"),
            the_pieces=baca.select.mgroups(o.rleaves(), [2, 1, 1, 1, 1, 2, 1, 1, 2]),
        )
    with baca.scope(m.get(12, 15)) as o:
        baca.hairpin(
            o.rleaves(),
            "(pp) >o niente o< mf >o niente",
            the_pieces=baca.select.mgroups(o.rleaves(), [1, 1, 3]),
        )
    with baca.scope(m.get(13, 15)) as o:
        ...
        baca.scp_spanner(
            ...
            autodetect_right_padding=False,
            bookend=-1,
            the_pieces=baca.select.mgroups(o.leaves(), [1, 2]),
        )
