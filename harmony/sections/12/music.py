...
# commands(
#    ("perc1", 14)
music = baca.make_mmrests_function(commands.get(14))
voice.extend(music)
...
# commands(
#    ("va", 10)
music = baca.make_notes_function(commands.get(10))
voice.extend(music)
