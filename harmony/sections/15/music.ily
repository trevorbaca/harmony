...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Bass_Flute.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Bass_Flute.Music_Staff = <<
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    \context Voice = "Bass_Flute.MusicVoice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.15.Bass_Flute.MusicVoice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.15.Percussion.1.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Percussion.1.Music_Staff = <<
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% { \number.15.GlobalRests }
    ...
    \context Voice = "Percussion.1.MusicVoice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.15.Percussion.1.MusicVoice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.15.Percussion.2.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Percussion.2.Music_Staff = <<
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% { \number.15.GlobalRests }
    ...
    \context Voice = "Percussion.2.MusicVoice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.15.Percussion.2.MusicVoice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.15.Contrabass.1.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Contrabass.1.Music_Staff = <<
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% { \number.15.GlobalRests }
    ...
    \context Voice = "Contrabass.1.MusicVoice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.15.Contrabass.1.MusicVoice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.15.Contrabass.2.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Contrabass.2.Music_Staff = <<
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% { \number.15.GlobalRests }
    ...
    \context Voice = "Contrabass.2.MusicVoice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.15.Contrabass.2.MusicVoice }
    % CLOSING:
    % COMMANDS:
