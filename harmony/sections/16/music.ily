...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.16.Bass_Flute.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Bass_Flute.Rest_Voice measure 11]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
...
number.16.Bass_Flute.Music_Staff = <<
    ...
    \context Voice = "Bass_Flute.Music_Voice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.16.Bass_Flute.Music_Voice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.16.Percussion.1.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Percussion.1.Rest_Voice measure 11]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
...
%%% { \number.16.Global_Rests }
    ...
    \context Voice = "Percussion.1.Music_Voice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.16.Percussion.1.Music_Voice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.16.Percussion.2.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Percussion.2.Rest_Voice measure 11]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
...
%%% { \number.16.Global_Rests }
    ...
    \context Voice = "Percussion.2.Music_Voice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.16.Percussion.2.Music_Voice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.16.Contrabass.1.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Contrabass.1.Rest_Voice measure 11]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
...
%%% { \number.16.Global_Rests }
    ...
    \context Voice = "Contrabass.1.Music_Voice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.16.Contrabass.1.Music_Voice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.16.Contrabass.2.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Contrabass.2.Rest_Voice measure 11]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
...
%%% { \number.16.Global_Rests }
    ...
    \context Voice = "Contrabass.2.Music_Voice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.16.Contrabass.2.Music_Voice }
    % CLOSING:
    % COMMANDS:
