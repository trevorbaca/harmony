...
number.18.Percussion.1.Music.item.1 = {
    ...
    % BEFORE:
    % COMMANDS:
      %! baca.dots_x_extent_false_function(1)
    \once \override Dots.X-extent = ##f
      %! baca.dots_extra_offset_function(1)
    \once \override Dots.extra-offset = #'(2 . 0)
      %! baca.rest_x_extent_zero_function(1)
...
number.18.Percussion.1.Music = {
    ...
    <<
        ...
        \context Voice = "Percussion.1.Music"
          %! baca.path.extern()
        { \number.18.Percussion.1.Music.item.1 }
        % CLOSING:
        % COMMANDS:
...
number.18.Percussion.2.Music = {
    ...
    <<
        ...
        \context Voice = "Percussion.2.Music"
          %! baca.path.extern()
        { \number.18.Percussion.2.Music.item.1 }
        % CLOSING:
        % COMMANDS:
...
number.18.Viola.Music = {
    ...
    % COMMANDS:
      %! INVISIBLE_MUSIC_COMMAND
      %! baca.invisible_music_function(1)
    %@% \abjad-invisible-music
      %! INVISIBLE_MUSIC_COLORING
      %! baca.invisible_music_function(2)
    \abjad-invisible-music-coloring
    <gs''! a'' bf''!>4 * 1/2
    % AFTER:
    % STEM_TREMOLOS:
