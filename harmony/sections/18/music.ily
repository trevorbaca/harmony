...
>>
  ...
  %! baca.path.extern()
number.18.Percussion.1.Music.count.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.18.Percussion.1.Music = {
    ...
    <<
        ...
        \context Voice = "Percussion.1.Music"
          %! baca.path.extern()
        { \number.18.Percussion.1.Music.count.1 }
        % CLOSING:
        % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.18.Percussion.2.Music.count.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.18.Percussion.2.Music = {
    ...
    <<
        ...
        \context Voice = "Percussion.2.Music"
          %! baca.path.extern()
        { \number.18.Percussion.2.Music.count.1 }
        % CLOSING:
        % COMMANDS:
