...
music = baca.make_mmrests_function(commands.get(7, 11))
voice.extend(music)
...
music = baca.make_notes_function(commands.get(6))
voice.extend(music)
...
music = library.make_tessera_2(0, function=commands.get(6))
voice.extend(music)
