...
number.20.BassFlute.Staff = <<

    \context GlobalRests = "Rests"
    { \number.20.Rests }

    \context Voice = "BassFlute.Music"
    { \number.20.BassFlute.Music }
