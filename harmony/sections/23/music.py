...
def BFL(voice, signatures):
    ...
    voice.extend(music)
    music = baca.make_mmrests(signatures(3), head=voice.name)
    voice.extend(music)
...
def PERC1(voice, signatures):
    ...
    voice.extend(music)
    music = baca.make_notes(signatures(7))
    voice.extend(music)
    music = library.make_sixteenths(
        signatures(8),
        [-8, 8, "-"],
...
def HP(voice, signatures):
    ...
    voice.extend(music)
    music = baca.make_mmrests(signatures(2, 5))
    voice.extend(music)
    music = library.make_sixteenths(
        signatures(6),
        [4, "-"],
...
def VA(voice, signatures):
    ...
    voice.extend(music)
    music = baca.make_notes(signatures(2))
    voice.extend(music)
...
def VC1(voice, signatures):
    ...
    durations = [_.duration for _ in signatures(6, 7)]
    durations = baca.sequence.fuse(durations)
    durations = baca.sequence.split(durations, [(2, 4), (4, 4), (3, 4)])
    music = library.make_sixteenths(
        signatures(6, 7),
        [-8, 4, 4, 4, 4, 4, 4],
        denominator=None,
...
def VC2(voice, signatures):
    ...
    voice.extend(music)
    music = baca.make_notes(signatures(5, 6))
    voice.extend(music)
    music = library.make_sixteenths(
        signatures(7),
        ["+"],
...
def CB1(voice, signatures):
    ...
    music = baca.make_notes(signatures(2))
    voice.extend(music)
    music = baca.make_mmrests(signatures(3, 5))
    voice.extend(music)
    durations = [_.duration for _ in signatures(6, 7)]
    durations = baca.sequence.fuse(durations)
    durations = baca.sequence.split(durations, [(2, 4), (4, 4), (3, 4)])
