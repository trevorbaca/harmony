            ...
            <<
                ...
                <<
                    ...
                    \context Staff = "Percussion.1.Music_Staff"
                      %! harmony.make_empty_score()
                      %! baca.path.extern()
                    { \segment.24.Percussion.1.Music.Staff }
                    % ABSOLUTE_BEFORE:
                    % COMMANDS:
                    ...
                    \context Staff = "Percussion.2.Music_Staff"
                      %! harmony.make_empty_score()
                      %! baca.path.extern()
                    { \segment.24.Percussion.2.Music.Staff }
                    % ABSOLUTE_BEFORE:
                    % COMMANDS:
                ...
                <<
                    ...
                    \context Staff = "Cello.1.Music_Staff"
                      %! harmony.make_empty_score()
                      %! baca.path.extern()
                    { \segment.24.Cello.1.Music.Staff }
                    % ABSOLUTE_BEFORE:
                    % COMMANDS:
                    ...
                    \context Staff = "Cello.2.Music_Staff"
                      %! harmony.make_empty_score()
                      %! baca.path.extern()
                    { \segment.24.Cello.2.Music.Staff }
                    % ABSOLUTE_BEFORE:
                    % COMMANDS:
                    ...
                    \context Staff = "Contrabass.1.Music_Staff"
                      %! harmony.make_empty_score()
                      %! baca.path.extern()
                    { \segment.24.Contrabass.1.Music.Staff }
                    % ABSOLUTE_BEFORE:
                    % COMMANDS:
                    ...
                    \context Staff = "Contrabass.2.Music_Staff"
                      %! harmony.make_empty_score()
                      %! baca.path.extern()
                    { \segment.24.Contrabass.2.Music.Staff }
                    % CLOSING:
                    % COMMANDS:
