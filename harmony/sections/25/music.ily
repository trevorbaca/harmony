...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.25.Bass_Flute.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.25.Bass_Flute.Music_Staff = <<
    ...
    \context Voice = "Bass_Flute.MusicVoice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.25.Bass_Flute.MusicVoice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.25.Percussion.1.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% { \number.25.GlobalRests }
    ...
    \context Voice = "Percussion.1.MusicVoice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.25.Percussion.1.MusicVoice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.25.Percussion.2.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% { \number.25.GlobalRests }
    ...
    \context Voice = "Percussion.2.MusicVoice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.25.Percussion.2.MusicVoice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.25.Contrabass.1.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% { \number.25.GlobalRests }
    ...
    \context Voice = "Contrabass.1.MusicVoice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.25.Contrabass.1.MusicVoice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.25.Contrabass.2.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% { \number.25.GlobalRests }
    ...
    \context Voice = "Contrabass.2.MusicVoice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.25.Contrabass.2.MusicVoice }
    % CLOSING:
    % COMMANDS:
