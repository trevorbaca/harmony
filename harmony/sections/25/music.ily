...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.25.Bass_Flute.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.25.Bass_Flute.Music_Staff = <<
    ...
    \context Voice = "Bass_Flute.Music_Voice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.25.Bass_Flute.Music_Voice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.25.Percussion.1.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% { \number.25.GlobalRests }
    ...
    \context Voice = "Percussion.1.Music_Voice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.25.Percussion.1.Music_Voice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.25.Percussion.2.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% { \number.25.GlobalRests }
    ...
    \context Voice = "Percussion.2.Music_Voice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.25.Percussion.2.Music_Voice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.25.Contrabass.1.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% { \number.25.GlobalRests }
    ...
    \context Voice = "Contrabass.1.Music_Voice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.25.Contrabass.1.Music_Voice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.25.Contrabass.2.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% { \number.25.GlobalRests }
    ...
    \context Voice = "Contrabass.2.Music_Voice"
      %! harmony.make_empty_score()
      %! baca.path.extern()
    { \number.25.Contrabass.2.Music_Voice }
    % CLOSING:
    % COMMANDS:
