            ...
            <<
                ...
                <<
                    ...
                    \context Staff = "Bass_Flute.Music_Staff"
                      %! harmony.make_empty_score()
                      %! baca.path.extern()
                    { \number.26.Bass_Flute.Music_Staff }
                    % CLOSING:
                    % COMMANDS:
                ...
                <<
                    ...
                    \context Staff = "Percussion.1.Music_Staff"
                      %! harmony.make_empty_score()
                      %! baca.path.extern()
                    { \number.26.Percussion.1.Music_Staff }
                    % ABSOLUTE_BEFORE:
                    % COMMANDS:
                    ...
                    \context Staff = "Percussion.2.Music_Staff"
                      %! harmony.make_empty_score()
                      %! baca.path.extern()
                    { \number.26.Percussion.2.Music_Staff }
                    % ABSOLUTE_BEFORE:
                    % COMMANDS:
                ...
                <<
                    ...
                    \context Staff = "Contrabass.1.Music_Staff"
                      %! harmony.make_empty_score()
                      %! baca.path.extern()
                    { \number.26.Contrabass.1.Music_Staff }
                    % ABSOLUTE_BEFORE:
                    % COMMANDS:
                    ...
                    \context Staff = "Contrabass.2.Music_Staff"
                      %! harmony.make_empty_score()
                      %! baca.path.extern()
                    { \number.26.Contrabass.2.Music_Staff }
                    % CLOSING:
                    % COMMANDS:
