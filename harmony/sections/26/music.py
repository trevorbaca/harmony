...
def PERC1(voice, signatures):
    ...
    voice.extend(music)
    durations = [_.duration for _ in signatures(9)]
...
def PERC2(voice, signatures):
    ...
    voice.extend(music)
    music = baca.make_mmrests(signatures(3, 6))
    voice.extend(music)
    music = library.make_sixteenths(
        signatures(7),
        [-8, "+"],
...
def VA(voice, signatures):
    ...
    voice.extend(music)
    music = baca.make_repeat_tied_notes(signatures(5, 7))
    voice.extend(music)
    music = library.make_sixteenths(
        signatures(8),
        [6, 3, 11],
...
def vc2(cache):
    ...
    with baca.scope(m[9]) as o:
        ...
        baca.hairpin(
            ...
            abjad.Tweak(r"- \tweak to-barline ##t"),
            bookend=False,
            the_pieces=baca.select.lparts(o, [1, 2, 3, 2]),
        )
    for item in [(1, 2), (5, 7), 10]:
        with baca.scope(m.get(item)) as o:
            baca.pitch(o, "C#2")
...
def cb1(cache):
    ...
    with baca.scope(m[9]) as o:
        ...
        baca.hairpin(
            ...
            abjad.Tweak(r"- \tweak to-barline ##t"),
            bookend=False,
            the_pieces=baca.select.lparts(o, [2, 3, 2]),
        )
    for item in [(1, 2), (5, 7), 10]:
        with baca.scope(m.get(item)) as o:
            baca.pitch(o, "D2")
...
def cb2(cache):
    ...
    with baca.scope(m[9]) as o:
        ...
        baca.hairpin(
            ...
            "pp -- ! < mp >",
            abjad.Tweak(r"- \tweak to-barline ##t"),
            the_pieces=baca.select.lparts(o, [2, 1, 1]),
        )
    for item in [(1, 2), (5, 7), 10]:
        with baca.scope(m.get(item)) as o:
            baca.pitch(o, "C#2")
