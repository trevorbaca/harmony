...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.27.Bass_Flute.Music.count.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.27.Bass_Flute.Music.count.2 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% \once \override Score.SpanBar.transparent = ##t
    ...
    <<
        ...
        \context Voice = "Bass_Flute.Music"
          %! baca.path.extern()
        { \number.27.Bass_Flute.Music.count.1 }
        % CLOSING:
        % COMMANDS:
    ...
    <<
        ...
        \context Voice = "Bass_Flute.Music"
          %! baca.path.extern()
        { \number.27.Bass_Flute.Music.count.2 }
        % CLOSING:
        % COMMANDS:
