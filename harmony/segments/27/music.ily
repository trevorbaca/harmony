...
%@%     %! SPANNER_START
    ...
    <<
        ...
        %! baca.SegmentMaker._make_multimeasure_rest_container(6)
        {
            ...
            %! baca.SegmentMaker._comment_measure_numbers()
            % [Bass_Flute_Rest_Voice measure 8]
            %! baca.SegmentMaker._make_multimeasure_rest_container(5)
            %! REST_VOICE
            %! MULTIMEASURE_REST
            R1 * 1/4
...
%@%     %! SPANNER_START
    ...
    <<
        ...
        %! baca.SegmentMaker._make_multimeasure_rest_container(6)
        {
            ...
            %! baca.SegmentMaker._comment_measure_numbers()
            % [Percussion_I_Rest_Voice measure 8]
            %! baca.SegmentMaker._make_multimeasure_rest_container(5)
            %! REST_VOICE
            %! MULTIMEASURE_REST
            R1 * 1/4
...
segment.27.Contrabass.I.Music.Voice = {
    ...
    <<
        ...
        %! baca.SegmentMaker._make_multimeasure_rest_container(6)
        {
            ...
            %! baca.SegmentMaker._comment_measure_numbers()
            % [Contrabass_I_Rest_Voice measure 1]
            %! baca.SegmentMaker._make_multimeasure_rest_container(5)
            %! REST_VOICE
            %! MULTIMEASURE_REST
            R1 * 7/4
...
%@%     %! SPANNER_START
    ...
    <<
        ...
        %! baca.SegmentMaker._make_multimeasure_rest_container(6)
        {
            ...
            %! baca.SegmentMaker._comment_measure_numbers()
            % [Contrabass_I_Rest_Voice measure 8]
            %! baca.SegmentMaker._make_multimeasure_rest_container(5)
            %! REST_VOICE
            %! MULTIMEASURE_REST
            R1 * 1/4
