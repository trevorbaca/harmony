...
%@% \override Staff.Clef.color = ##f                                           %! DEFAULT_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [A Bass_Flute_Rest_Voice measure 3]                              %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! DEFAULT_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [A Percussion_I_Rest_Voice measure 3]                            %! _comment_measure_numbers
            R1 * 3/4                                                           %! _make_multimeasure_rest_container
...
%@% \override Staff.Clef.color = ##f                                           %! DEFAULT_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    \once \override Staff.InstrumentName.color = #(x11-color 'blue)            %! EXPLICIT_MARGIN_MARKUP_COLOR:_attach_color_literal(2)
    \once \override Staff.StaffSymbol.color = #(x11-color 'blue)               %! EXPLICIT_STAFF_LINES_COLOR:_attach_color_literal(2)
    c''4                                                                       %! harmony.quarter_initiated_cells
    ^ \baca-default-indicator-markup "(“Percussion”)"                          %! DEFAULT_INSTRUMENT_ALERT:_attach_latent_indicator_alert
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [A Percussion_II_Rest_Voice measure 3]                           %! _comment_measure_numbers
            R1 * 3/4                                                           %! _make_multimeasure_rest_container
...
%@% \override Staff.Clef.color = ##f                                           %! DEFAULT_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [A Harp_Rest_Voice measure 3]                                    %! _comment_measure_numbers
            R1 * 3/4                                                           %! _make_multimeasure_rest_container
...
%@% \override Staff.Clef.color = ##f                                           %! DEFAULT_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [A Viola_Rest_Voice measure 3]                                   %! _comment_measure_numbers
            R1 * 3/4                                                           %! _make_multimeasure_rest_container
...
%@% \override Staff.Clef.color = ##f                                           %! DEFAULT_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [A Cello_I_Rest_Voice measure 3]                                 %! _comment_measure_numbers
            R1 * 3/4                                                           %! _make_multimeasure_rest_container
...
%@% \override Staff.Clef.color = ##f                                           %! DEFAULT_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [A Cello_II_Rest_Voice measure 3]                                %! _comment_measure_numbers
            R1 * 3/4                                                           %! _make_multimeasure_rest_container
...
%@% \override Staff.Clef.color = ##f                                           %! DEFAULT_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [A Contrabass_I_Rest_Voice measure 3]                            %! _comment_measure_numbers
            R1 * 3/4                                                           %! _make_multimeasure_rest_container
...
%@% \override Staff.Clef.color = ##f                                           %! DEFAULT_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [A Contrabass_II_Rest_Voice measure 3]                           %! _comment_measure_numbers
            R1 * 3/4                                                           %! _make_multimeasure_rest_container
