...
maker(
    ("vc2", 1),
    harmony.sixteenths([10, "-"], untie=True, grace_suffixes=[1]),
...
maker(
    ("vc2", (6, 8)),
    harmony.sixteenths([18, -12, 16, -4], untie=True, grace_suffixes=[1]),
    baca.new(
        baca.interpolate_staff_positions(-1, 1, mock=True),
        baca.glissando(
            allow_repeats=True,
