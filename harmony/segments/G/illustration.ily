G_Global_Skips = {                                                             %! abjad.Path.extern
    ...
    % [G Global_Skips measure 55 / measure 1]                                  %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [G Global_Skips measure 56 / measure 2]                                  %! _comment_measure_numbers
...
%@% \bacaStartTextSpanMN                                                       %! MEASURE_NUMBER
    - \baca-start-snm-colored-left-only "[▶H.1]" #darkgreen                    %! STAGE_NUMBER
    \bacaStartTextSpanSNM                                                      %! STAGE_NUMBER
%@% - \abjad-invisible-line                                                    %! EXPLICIT_METRONOME_MARK:_set_status_tag:_attach_metronome_marks(2)
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [G Global_Skips measure 57 / measure 3]                                  %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [G Global_Skips measure 58 / measure 4]                                  %! _comment_measure_numbers
...
%@% \bacaStartTextSpanMN                                                       %! MEASURE_NUMBER
    - \baca-start-snm-left-only "[G.2-3]"                                      %! STAGE_NUMBER
    \bacaStartTextSpanSNM                                                      %! STAGE_NUMBER
%@% - \abjad-invisible-line                                                    %! EXPLICIT_METRONOME_MARK:_set_status_tag:_attach_metronome_marks(2)
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [G Global_Skips measure 59 / measure 5]                                  %! _comment_measure_numbers
    s1 * 1                                                                     %! _make_global_skips(1)
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER
%@% \bacaStopTextSpanCT                                                        %! CLOCK_TIME
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [G Global_Skips measure 60 / measure 6]                                  %! _comment_measure_numbers
...
%@% \bacaStartTextSpanMN                                                       %! MEASURE_NUMBER
    ...
    \bacaStartTextSpanSNM                                                      %! STAGE_NUMBER
%@% - \abjad-invisible-line                                                    %! EXPLICIT_METRONOME_MARK:_set_status_tag:_attach_metronome_marks(2)
%@% - \baca-bracketed-metric-modulation-tuplet-lhs #2 #0 #1 #"48" #2 #0 #6 #5 #2 #0 #'(1 . 1) %! EXPLICIT_METRONOME_MARK:_set_status_tag:_attach_metronome_marks(2)
%@% \bacaStartTextSpanMM                                                       %! EXPLICIT_METRONOME_MARK:_set_status_tag:_attach_metronome_marks(2)
    - \abjad-invisible-line                                                    %! EXPLICIT_METRONOME_MARK_WITH_COLOR:_attach_metronome_marks(3)
    - \baca-colored-bracketed-metric-modulation-tuplet-lhs #2 #0 #1 #"48" #2 #0 #6 #5 #2 #0 #'(1 . 1) #'blue %! EXPLICIT_METRONOME_MARK_WITH_COLOR:_attach_metronome_marks(3)
    \bacaStartTextSpanMM                                                       %! EXPLICIT_METRONOME_MARK_WITH_COLOR:_attach_metronome_marks(3)
%@% - \baca-start-ct-left-only "[3'16'']"                                      %! CLOCK_TIME
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME

    % [G Global_Skips measure 61 / measure 7]                                  %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [G Global_Skips measure 62 / measure 8]                                  %! _comment_measure_numbers
    \time 4/4                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca-time-signature-color #'blue                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1                                                                     %! _make_global_skips(1)
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER
...
%@% \bacaStartTextSpanMM                                                       %! EXPLICIT_METRONOME_MARK:_set_status_tag:_attach_metronome_marks(2)
    ...
    \bacaStartTextSpanMM                                                       %! EXPLICIT_METRONOME_MARK_WITH_COLOR:_attach_metronome_marks(3)
%@% - \baca-start-ct-both "[3'25'']" "[3'29'']"                                %! CLOCK_TIME
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    \baca-bar-line-visible                                                     %! _attach_final_bar_line
    \bar "|"                                                                   %! _attach_final_bar_line

    % [G Global_Skips measure 63 / measure 9]                                  %! PHANTOM:_style_phantom_measures(1):_comment_measure_numbers
...
G_Global_Rests = {                                                             %! abjad.Path.extern
    ...
    % [G Global_Rests measure 55 / measure 1]                                  %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [G Global_Rests measure 56 / measure 2]                                  %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _make_global_rests(1)

    % [G Global_Rests measure 57 / measure 3]                                  %! _comment_measure_numbers
    \once \override MultiMeasureRestText.extra-offset = #'(0 . 2.5)
    \baca-fermata-measure                                                      %! baca.global_fermata:GlobalFermataCommand(2)
    R1 * 1/4                                                                   %! _make_global_rests(1)
    ^ \baca-fermata-markup                                                     %! baca.global_fermata:GlobalFermataCommand(1)

    % [G Global_Rests measure 58 / measure 4]                                  %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [G Global_Rests measure 59 / measure 5]                                  %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [G Global_Rests measure 60 / measure 6]                                  %! _comment_measure_numbers
    R1 * 5/4                                                                   %! _make_global_rests(1)

    % [G Global_Rests measure 61 / measure 7]                                  %! _comment_measure_numbers
    R1 * 3/2                                                                   %! _make_global_rests(1)

    % [G Global_Rests measure 62 / measure 8]                                  %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [G Global_Rests measure 63 / measure 9]                                  %! PHANTOM:_style_phantom_measures(4):_comment_measure_numbers
...
G_Bass_Flute_Music_Voice = {                                                   %! abjad.Path.extern
    ...
    % [G Bass_Flute_Music_Voice measure 55 / measure 1]                        %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    r2.                                                                        %! harmony.flutter_initiated_cells
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    \!                                                                         %! EXPLICIT_DYNAMIC:_set_status_tag:baca.hairpin:PiecewiseCommand(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Bass_Flute_Music_Voice measure 56 / measure 2]                %! _comment_measure_numbers
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Bass_Flute_Rest_Voice measure 56 / measure 2]                 %! _comment_measure_numbers
    ...
    % [G Bass_Flute_Music_Voice measure 57 / measure 3]                        %! _comment_measure_numbers
    \stopStaff                                                                 %! _style_fermata_measures(1)
    \once \override Staff.StaffSymbol.line-count = 0                           %! _style_fermata_measures(1)
    \startStaff                                                                %! _style_fermata_measures(1)
    R1 * 1/4                                                                   %! _make_measure_silences
%%% \once \override Score.BarLine.transparent = ##t                            %! _style_fermata_measures(4):EOL_FERMATA:MEASURE_57
%%% \once \override Score.SpanBar.transparent = ##t                            %! _style_fermata_measures(4):EOL_FERMATA:MEASURE_57

    % [G Bass_Flute_Music_Voice measure 58 / measure 4]                        %! _comment_measure_numbers
    ...
    % [G Bass_Flute_Music_Voice measure 59 / measure 5]                        %! _comment_measure_numbers
    r2.                                                                        %! harmony.sixteenths
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Bass_Flute_Music_Voice measure 60 / measure 6]                %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Bass_Flute_Rest_Voice measure 60 / measure 6]                 %! _comment_measure_numbers
    ...
    % [G Bass_Flute_Music_Voice measure 61 / measure 7]                        %! _comment_measure_numbers
    R1 * 3/2                                                                   %! _make_measure_silences

    % [G Bass_Flute_Music_Voice measure 62 / measure 8]                        %! _comment_measure_numbers
    \override DynamicLineSpanner.staff-padding = #5.5                          %! baca.dls_staff_padding:OverrideCommand(1)
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    c''16                                                                      %! harmony.sixteenths
    :32                                                                        %! baca.stem_tremolo:IndicatorCommand
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [G Bass_Flute_Music_Voice measure 63 / measure 9]                %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [G Bass_Flute_Rest_Voice measure 63 / measure 9]                 %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
...
G_Percussion_I_Music_Voice = {                                                 %! abjad.Path.extern
    ...
    % [G Percussion_I_Music_Voice measure 55 / measure 1]                      %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Percussion_I_Music_Voice measure 56 / measure 2]              %! _comment_measure_numbers
            \stopStaff                                                         %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Percussion_I_Rest_Voice measure 56 / measure 2]               %! _comment_measure_numbers
            R1 * 3/4                                                           %! _make_multimeasure_rest_container
    ...
    % [G Percussion_I_Music_Voice measure 57 / measure 3]                      %! _comment_measure_numbers
    \stopStaff                                                                 %! _style_fermata_measures(1)
    \once \override Staff.StaffSymbol.line-count = 0                           %! _style_fermata_measures(1)
    \startStaff                                                                %! _style_fermata_measures(1)
    R1 * 1/4                                                                   %! _make_measure_silences

    % [G Percussion_I_Music_Voice measure 58 / measure 4]                      %! _comment_measure_numbers
    \override Staff.BarLine.bar-extent = #'(-2 . 1)                            %! EXPLICIT_BAR_EXTENT:_set_status_tag:-PARTS:IndicatorCommand
    \stopStaff                                                                 %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
    \once \override Staff.StaffSymbol.line-count = 3                           %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
    \startStaff                                                                %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
    ...
    % [G Percussion_I_Music_Voice measure 59 / measure 5]                      %! _comment_measure_numbers
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Percussion_I_Music_Voice measure 60 / measure 6]              %! _comment_measure_numbers
            \stopStaff                                                         %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
            \once \override Staff.StaffSymbol.line-count = 1                   %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
            \startStaff                                                        %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Percussion_I_Rest_Voice measure 60 / measure 6]               %! _comment_measure_numbers
            R1 * 5/4                                                           %! _make_multimeasure_rest_container
    ...
    % [G Percussion_I_Music_Voice measure 61 / measure 7]                      %! _comment_measure_numbers
    R1 * 3/2                                                                   %! _make_measure_silences

    % [G Percussion_I_Music_Voice measure 62 / measure 8]                      %! _comment_measure_numbers
    \override Staff.BarLine.bar-extent = #'(-2 . 1)                            %! EXPLICIT_BAR_EXTENT:_set_status_tag:-PARTS:IndicatorCommand
    \stopStaff                                                                 %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
    \once \override Staff.StaffSymbol.line-count = 3                           %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
    \startStaff                                                                %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [G Percussion_I_Music_Voice measure 63 / measure 9]              %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [G Percussion_I_Rest_Voice measure 63 / measure 9]               %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
G_Percussion_II_Music_Voice = {                                                %! abjad.Path.extern
    ...
    % [G Percussion_II_Music_Voice measure 55 / measure 1]                     %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    % [G Percussion_II_Music_Voice measure 56 / measure 2]                     %! _comment_measure_numbers
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Percussion_II_Music_Voice measure 57 / measure 3]             %! _comment_measure_numbers
            \stopStaff                                                         %! _style_fermata_measures(1)
            \once \override Staff.StaffSymbol.line-count = 0                   %! _style_fermata_measures(1)
            \startStaff                                                        %! _style_fermata_measures(1)
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Percussion_II_Rest_Voice measure 57 / measure 3]              %! _comment_measure_numbers
    ...
    % [G Percussion_II_Music_Voice measure 58 / measure 4]                     %! _comment_measure_numbers
    \stopStaff                                                                 %! _style_fermata_measures(2)
    ...
    % [G Percussion_II_Music_Voice measure 59 / measure 5]                     %! _comment_measure_numbers
    \hide NoteHead                                                             %! baca.glissando
    \override Accidental.stencil = ##f                                         %! baca.glissando
    \override NoteColumn.glissando-skip = ##t                                  %! baca.glissando
    \override NoteHead.no-ledgers = ##t                                        %! baca.glissando
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Percussion_II_Music_Voice measure 60 / measure 6]             %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
            c'1 * 5/4                                                          %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Percussion_II_Rest_Voice measure 60 / measure 6]              %! _comment_measure_numbers
            R1 * 5/4                                                           %! _make_multimeasure_rest_container
    ...
    % [G Percussion_II_Music_Voice measure 61 / measure 7]                     %! _comment_measure_numbers
    R1 * 3/2                                                                   %! _make_measure_silences

    % [G Percussion_II_Music_Voice measure 62 / measure 8]                     %! _comment_measure_numbers
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [G Percussion_II_Music_Voice measure 63 / measure 9]             %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [G Percussion_II_Rest_Voice measure 63 / measure 9]              %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
G_Harp_Music_Voice = {                                                         %! abjad.Path.extern
    ...
    % [G Harp_Music_Voice measure 55 / measure 1]                              %! _comment_measure_numbers
...
%%% \once \override Staff.Clef.X-extent = ##f                                  %! MEASURE_55:SHIFTED_CLEF:baca.clef_shift:OverrideCommand(1)
%%% \once \override Staff.Clef.extra-offset = #'(-2.5 . 0)                     %! MEASURE_55:SHIFTED_CLEF:baca.clef_shift:OverrideCommand(1)
...
%@% \override Staff.Clef.color = ##f                                           %! EXPLICIT_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Harp_Music_Voice measure 56 / measure 2]                      %! _comment_measure_numbers
            ...
            \startStaff                                                        %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
            \once \override Staff.Clef.X-extent = ##f                          %! MEASURE_56:SHIFTED_CLEF:baca.clef_shift:OverrideCommand(1)
            \once \override Staff.Clef.extra-offset = #'(-2.5 . 0)             %! MEASURE_56:SHIFTED_CLEF:baca.clef_shift:OverrideCommand(1)
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Harp_Rest_Voice measure 56 / measure 2]                       %! _comment_measure_numbers
            R1 * 3/4                                                           %! _make_multimeasure_rest_container
    ...
    % [G Harp_Music_Voice measure 57 / measure 3]                              %! _comment_measure_numbers
    \stopStaff                                                                 %! _style_fermata_measures(1)
    \once \override Staff.StaffSymbol.line-count = 0                           %! _style_fermata_measures(1)
    \startStaff                                                                %! _style_fermata_measures(1)
    R1 * 1/4                                                                   %! _make_measure_silences

    % [G Harp_Music_Voice measure 58 / measure 4]                              %! _comment_measure_numbers
    \stopStaff                                                                 %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
    \once \override Staff.StaffSymbol.line-count = 1                           %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
    \startStaff                                                                %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
    \override Stem.direction = #down                                           %! baca.stem_down:OverrideCommand(1)
    \once \override Staff.Clef.X-extent = ##f                                  %! MEASURE_58:SHIFTED_CLEF:baca.clef_shift:OverrideCommand(1)
    \once \override Staff.Clef.extra-offset = #'(-2.5 . 0)                     %! MEASURE_58:SHIFTED_CLEF:baca.clef_shift:OverrideCommand(1)
    \clef "percussion"                                                         %! EXPLICIT_CLEF:_set_status_tag:baca.clef:IndicatorCommand
    \once \override Staff.Clef.color = #(x11-color 'blue)                      %! EXPLICIT_CLEF_COLOR:_attach_color_literal(2)
%@% \override Staff.Clef.color = ##f                                           %! EXPLICIT_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    \set Staff.forceClef = ##t                                                 %! EXPLICIT_CLEF:_set_status_tag:_treat_persistent_wrapper(2):baca.clef:IndicatorCommand
    ...
    % [G Harp_Music_Voice measure 59 / measure 5]                              %! _comment_measure_numbers
    r2.                                                                        %! harmony.sixteenths
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Harp_Music_Voice measure 60 / measure 6]                      %! _comment_measure_numbers
            \override Staff.BarLine.bar-extent = #'(-2 . 2)                    %! EXPLICIT_BAR_EXTENT:_set_status_tag:-PARTS:IndicatorCommand
            \stopStaff                                                         %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
            \once \override Staff.StaffSymbol.line-count = 5                   %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
            \startStaff                                                        %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Harp_Rest_Voice measure 60 / measure 6]                       %! _comment_measure_numbers
            R1 * 5/4                                                           %! _make_multimeasure_rest_container
    ...
    % [G Harp_Music_Voice measure 61 / measure 7]                              %! _comment_measure_numbers
    R1 * 3/2                                                                   %! _make_measure_silences

    % [G Harp_Music_Voice measure 62 / measure 8]                              %! _comment_measure_numbers
    \stopStaff                                                                 %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
    \once \override Staff.StaffSymbol.line-count = 1                           %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
    \startStaff                                                                %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
    \once \override Stem.direction = #down                                     %! baca.stem_down:OverrideCommand(1)
...
%@% \override Staff.Clef.color = ##f                                           %! EXPLICIT_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [G Harp_Music_Voice measure 63 / measure 9]                      %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [G Harp_Rest_Voice measure 63 / measure 9]                       %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
G_Viola_Music_Voice_B = {                                                      %! abjad.Path.extern
    ...
    % [G Viola_Music_Voice measure 59 / measure 5]                             %! _comment_measure_numbers
    \once \override NoteHead.style = #'harmonic                                %! baca.literal:IndicatorCommand
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    \afterGrace
    c'1
...
G_Viola_Music_Voice = {                                                        %! abjad.Path.extern
    ...
    <<
        ...
        \context Voice = "On_Beat_Grace_Container"
        {
            ...
            % [G Viola_Music_Voice measure 55 / measure 1]                     %! _comment_measure_numbers
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Viola_Music_Voice measure 56 / measure 2]                     %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
            c'1 * 3/4                                                          %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Viola_Rest_Voice measure 56 / measure 2]                      %! _comment_measure_numbers
            R1 * 3/4                                                           %! _make_multimeasure_rest_container
    ...
    % [G Viola_Music_Voice measure 57 / measure 3]                             %! _comment_measure_numbers
    \stopStaff                                                                 %! _style_fermata_measures(1)
    \once \override Staff.StaffSymbol.line-count = 0                           %! _style_fermata_measures(1)
    \startStaff                                                                %! _style_fermata_measures(1)
    R1 * 1/4                                                                   %! _make_measure_silences
    ...
    <<
        ...
        \context Voice = "On_Beat_Grace_Container"
        {
            ...
            % [G Viola_Music_Voice measure 58 / measure 4]                     %! _comment_measure_numbers
            \stopStaff                                                         %! _style_fermata_measures(2)
            \once \override Staff.StaffSymbol.line-count = 5                   %! _style_fermata_measures(2)
            \startStaff                                                        %! _style_fermata_measures(2)
            \once \override NoteHead.style = #'harmonic                        %! baca.literal:IndicatorCommand
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Viola_Music_Voice measure 60 / measure 6]                     %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
            c'1 * 5/4                                                          %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Viola_Rest_Voice measure 60 / measure 6]                      %! _comment_measure_numbers
            R1 * 5/4                                                           %! _make_multimeasure_rest_container
    ...
    % [G Viola_Music_Voice measure 61 / measure 7]                             %! _comment_measure_numbers
    R1 * 3/2                                                                   %! _make_measure_silences

    % [G Viola_Music_Voice measure 62 / measure 8]                             %! _comment_measure_numbers
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [G Viola_Music_Voice measure 63 / measure 9]                     %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [G Viola_Rest_Voice measure 63 / measure 9]                      %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
G_Cello_I_Music_Voice_B = {                                                    %! abjad.Path.extern
    ...
    % [G Cello_I_Music_Voice measure 59 / measure 5]                           %! _comment_measure_numbers
    \once \override NoteHead.style = #'harmonic                                %! baca.literal:IndicatorCommand
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    \afterGrace
    d1
...
G_Cello_I_Music_Voice = {                                                      %! abjad.Path.extern
    ...
    <<
        ...
        \context Voice = "On_Beat_Grace_Container"
        {
            ...
            % [G Cello_I_Music_Voice measure 55 / measure 1]                   %! _comment_measure_numbers
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Cello_I_Music_Voice measure 56 / measure 2]                   %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
            c'1 * 3/4                                                          %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Cello_I_Rest_Voice measure 56 / measure 2]                    %! _comment_measure_numbers
            R1 * 3/4                                                           %! _make_multimeasure_rest_container
    ...
    % [G Cello_I_Music_Voice measure 57 / measure 3]                           %! _comment_measure_numbers
    \stopStaff                                                                 %! _style_fermata_measures(1)
    \once \override Staff.StaffSymbol.line-count = 0                           %! _style_fermata_measures(1)
    \startStaff                                                                %! _style_fermata_measures(1)
    R1 * 1/4                                                                   %! _make_measure_silences
    ...
    <<
        ...
        \context Voice = "On_Beat_Grace_Container"
        {
            ...
            % [G Cello_I_Music_Voice measure 58 / measure 4]                   %! _comment_measure_numbers
            \stopStaff                                                         %! _style_fermata_measures(2)
            \once \override Staff.StaffSymbol.line-count = 5                   %! _style_fermata_measures(2)
            \startStaff                                                        %! _style_fermata_measures(2)
            \once \override NoteHead.style = #'harmonic                        %! baca.literal:IndicatorCommand
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Cello_I_Music_Voice measure 60 / measure 6]                   %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
            c'1 * 5/4                                                          %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Cello_I_Rest_Voice measure 60 / measure 6]                    %! _comment_measure_numbers
            R1 * 5/4                                                           %! _make_multimeasure_rest_container
    ...
    % [G Cello_I_Music_Voice measure 61 / measure 7]                           %! _comment_measure_numbers
    R1 * 3/2                                                                   %! _make_measure_silences

    % [G Cello_I_Music_Voice measure 62 / measure 8]                           %! _comment_measure_numbers
    \once \override NoteHead.style = #'harmonic                                %! baca.note_head_style_harmonic:OverrideCommand(1)
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [G Cello_I_Music_Voice measure 63 / measure 9]                   %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [G Cello_I_Rest_Voice measure 63 / measure 9]                    %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
G_Cello_II_Music_Voice = {                                                     %! abjad.Path.extern
    ...
    % [G Cello_II_Music_Voice measure 55 / measure 1]                          %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Cello_II_Music_Voice measure 56 / measure 2]                  %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
            c'1 * 3/4                                                          %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Cello_II_Rest_Voice measure 56 / measure 2]                   %! _comment_measure_numbers
            R1 * 3/4                                                           %! _make_multimeasure_rest_container
    ...
    % [G Cello_II_Music_Voice measure 57 / measure 3]                          %! _comment_measure_numbers
    \stopStaff                                                                 %! _style_fermata_measures(1)
    \once \override Staff.StaffSymbol.line-count = 0                           %! _style_fermata_measures(1)
    \startStaff                                                                %! _style_fermata_measures(1)
    R1 * 1/4                                                                   %! _make_measure_silences

    % [G Cello_II_Music_Voice measure 58 / measure 4]                          %! _comment_measure_numbers
    \stopStaff                                                                 %! _style_fermata_measures(2)
    \once \override Staff.StaffSymbol.line-count = 5                           %! _style_fermata_measures(2)
    \startStaff                                                                %! _style_fermata_measures(2)
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    ...
    % [G Cello_II_Music_Voice measure 59 / measure 5]                          %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    d1                                                                         %! harmony.sixteenths
    - \tweak direction #up
    \repeatTie
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Cello_II_Music_Voice measure 60 / measure 6]                  %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
            c'1 * 5/4                                                          %! _make_multimeasure_rest_container
            \bacaStopTextSpanDamp                                              %! DAMP:baca.damp_spanner:PiecewiseCommand(3)
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Cello_II_Rest_Voice measure 60 / measure 6]                   %! _comment_measure_numbers
            R1 * 5/4                                                           %! _make_multimeasure_rest_container
    ...
    % [G Cello_II_Music_Voice measure 61 / measure 7]                          %! _comment_measure_numbers
    R1 * 3/2                                                                   %! _make_measure_silences

    % [G Cello_II_Music_Voice measure 62 / measure 8]                          %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    d1                                                                         %! baca.make_repeat_tied_notes
    - \abjad-dashed-line-with-hook                                             %! DAMP:baca.damp_spanner:PiecewiseCommand(1)
    - \baca-text-spanner-left-markup \baca-damp-markup                         %! DAMP:baca.damp_spanner:PiecewiseCommand(1)
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [G Cello_II_Music_Voice measure 63 / measure 9]                  %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [G Cello_II_Rest_Voice measure 63 / measure 9]                   %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
G_Contrabass_I_Music_Voice_B = {                                               %! abjad.Path.extern
    ...
    % [G Contrabass_I_Music_Voice measure 59 / measure 5]                      %! _comment_measure_numbers
    \once \override NoteHead.style = #'harmonic                                %! baca.literal:IndicatorCommand
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    \afterGrace
    d1
...
G_Contrabass_I_Music_Voice = {                                                 %! abjad.Path.extern
    ...
    <<
        ...
        \context Voice = "On_Beat_Grace_Container"
        {
            ...
            % [G Contrabass_I_Music_Voice measure 55 / measure 1]              %! _comment_measure_numbers
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Contrabass_I_Music_Voice measure 56 / measure 2]              %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
            c''1 * 3/4                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Contrabass_I_Rest_Voice measure 56 / measure 2]               %! _comment_measure_numbers
            R1 * 3/4                                                           %! _make_multimeasure_rest_container
    ...
    % [G Contrabass_I_Music_Voice measure 57 / measure 3]                      %! _comment_measure_numbers
    \stopStaff                                                                 %! _style_fermata_measures(1)
    \once \override Staff.StaffSymbol.line-count = 0                           %! _style_fermata_measures(1)
    \startStaff                                                                %! _style_fermata_measures(1)
    R1 * 1/4                                                                   %! _make_measure_silences
    ...
    <<
        ...
        \context Voice = "On_Beat_Grace_Container"
        {
            ...
            % [G Contrabass_I_Music_Voice measure 58 / measure 4]              %! _comment_measure_numbers
            \stopStaff                                                         %! _style_fermata_measures(2)
            \once \override Staff.StaffSymbol.line-count = 5                   %! _style_fermata_measures(2)
            \startStaff                                                        %! _style_fermata_measures(2)
            \once \override NoteHead.style = #'harmonic                        %! baca.literal:IndicatorCommand
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Contrabass_I_Music_Voice measure 60 / measure 6]              %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
            c''1 * 5/4                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Contrabass_I_Rest_Voice measure 60 / measure 6]               %! _comment_measure_numbers
            R1 * 5/4                                                           %! _make_multimeasure_rest_container
    ...
    % [G Contrabass_I_Music_Voice measure 61 / measure 7]                      %! _comment_measure_numbers
    R1 * 3/2                                                                   %! _make_measure_silences

    % [G Contrabass_I_Music_Voice measure 62 / measure 8]                      %! _comment_measure_numbers
    \once \override NoteHead.style = #'harmonic                                %! baca.note_head_style_harmonic:OverrideCommand(1)
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    d1                                                                         %! baca.make_repeat_tied_notes
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [G Contrabass_I_Music_Voice measure 63 / measure 9]              %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c''1 * 1/4                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [G Contrabass_I_Rest_Voice measure 63 / measure 9]               %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
G_Contrabass_II_Music_Voice = {                                                %! abjad.Path.extern
    ...
    % [G Contrabass_II_Music_Voice measure 55 / measure 1]                     %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Contrabass_II_Music_Voice measure 56 / measure 2]             %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
            c''1 * 3/4                                                         %! _make_multimeasure_rest_container
            \bacaStopTextSpanDamp                                              %! DAMP:baca.damp_spanner:PiecewiseCommand(3)
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Contrabass_II_Rest_Voice measure 56 / measure 2]              %! _comment_measure_numbers
            R1 * 3/4                                                           %! _make_multimeasure_rest_container
    ...
    % [G Contrabass_II_Music_Voice measure 57 / measure 3]                     %! _comment_measure_numbers
    \stopStaff                                                                 %! _style_fermata_measures(1)
    \once \override Staff.StaffSymbol.line-count = 0                           %! _style_fermata_measures(1)
    \startStaff                                                                %! _style_fermata_measures(1)
    R1 * 1/4                                                                   %! _make_measure_silences

    % [G Contrabass_II_Music_Voice measure 58 / measure 4]                     %! _comment_measure_numbers
    \stopStaff                                                                 %! _style_fermata_measures(2)
    \once \override Staff.StaffSymbol.line-count = 5                           %! _style_fermata_measures(2)
    \startStaff                                                                %! _style_fermata_measures(2)
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    ...
    % [G Contrabass_II_Music_Voice measure 59 / measure 5]                     %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    d1                                                                         %! harmony.sixteenths
    - \tweak direction #up
    \repeatTie
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Contrabass_II_Music_Voice measure 60 / measure 6]             %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
            c''1 * 5/4                                                         %! _make_multimeasure_rest_container
            \bacaStopTextSpanDamp                                              %! DAMP:baca.damp_spanner:PiecewiseCommand(3)
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Contrabass_II_Rest_Voice measure 60 / measure 6]              %! _comment_measure_numbers
            R1 * 5/4                                                           %! _make_multimeasure_rest_container
    ...
    % [G Contrabass_II_Music_Voice measure 61 / measure 7]                     %! _comment_measure_numbers
    R1 * 3/2                                                                   %! _make_measure_silences

    % [G Contrabass_II_Music_Voice measure 62 / measure 8]                     %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    d1                                                                         %! baca.make_repeat_tied_notes
    - \abjad-dashed-line-with-hook                                             %! DAMP:baca.damp_spanner:PiecewiseCommand(1)
    - \baca-text-spanner-left-markup \baca-damp-markup                         %! DAMP:baca.damp_spanner:PiecewiseCommand(1)
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [G Contrabass_II_Music_Voice measure 63 / measure 9]             %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c''1 * 1/4                                                         %! PHANTOM:_make_multimeasure_rest_container
            \bacaStopTextSpanDamp                                              %! PHANTOM:_style_phantom_measures(5):DAMP:baca.damp_spanner:PiecewiseCommand(3)
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [G Contrabass_II_Rest_Voice measure 63 / measure 9]              %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
