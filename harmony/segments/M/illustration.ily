...
%%% \once \override Staff.Clef.X-extent = ##f                                  %! MEASURE_114:SHIFTED_CLEF:baca.clef_shift:OverrideCommand(1)
%%% \once \override Staff.Clef.extra-offset = #'(-2.5 . 0)                     %! MEASURE_114:SHIFTED_CLEF:baca.clef_shift:OverrideCommand(1)
