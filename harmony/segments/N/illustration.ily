...
N_Global_Rests = {                                                             %! ide.Path.extern()
    ...
    % [N Global_Rests measure 131 / measure 12]                                %! baca.SegmentMaker._comment_measure_numbers()
    R1 * 1/4                                                                   %! baca.SegmentMaker._make_global_rests(2):PHANTOM

}                                                                              %! ide.Path.extern()


N_Bass_Flute_Music_Voice = {                                                   %! ide.Path.extern()
...
N_Bass_Flute_Music_Staff = <<                                                  %! ide.Path.extern()
...
N_Percussion_I_Music_Voice_A = {                                               %! ide.Path.extern()
...
N_Percussion_I_Music_Voice_B = {                                               %! ide.Path.extern()
...
N_Percussion_I_Music_Voice = {                                                 %! ide.Path.extern()
...
N_Percussion_II_Music_Voice_A = {                                              %! ide.Path.extern()
...
N_Percussion_II_Music_Voice_B = {                                              %! ide.Path.extern()
...
N_Percussion_II_Music_Voice = {                                                %! ide.Path.extern()
...
%@% ^ \baca-reapplied-indicator-markup "(“Percussion”)"                        %! REAPPLIED_INSTRUMENT_ALERT:baca.SegmentMaker._attach_latent_indicator_alert()
%@% - \abjad-dashed-line-with-hook                                             %! baca.rhythm_annotation_spanner():RHYTHM_ANNOTATION_SPANNER:baca.PiecewiseCommand._call(2):SPANNER_START
%@% - \baca-text-spanner-left-text "sixteenths([-22, 1, -3, 1, '-'], denominator=None, extra_counts=[2], talea_denominator=16)" %! baca.rhythm_annotation_spanner():RHYTHM_ANNOTATION_SPANNER:baca.PiecewiseCommand._call(2):SPANNER_START
%@% - \tweak bound-details.right.padding #2.75                                 %! baca.rhythm_annotation_spanner():RHYTHM_ANNOTATION_SPANNER:baca.PiecewiseCommand._call(2):AUTODETECT:SPANNER_START
%@% - \tweak color #darkyellow                                                 %! baca.rhythm_annotation_spanner():RHYTHM_ANNOTATION_SPANNER:baca.PiecewiseCommand._call(2):SPANNER_START
%@% - \tweak staff-padding #8                                                  %! baca.rhythm_annotation_spanner():RHYTHM_ANNOTATION_SPANNER:baca.PiecewiseCommand._call(2):SPANNER_START
%@% \bacaStartTextSpanRhythmAnnotation                                         %! baca.rhythm_annotation_spanner():RHYTHM_ANNOTATION_SPANNER:baca.PiecewiseCommand._call(2):SPANNER_START
...
%@% ^ \baca-duration-multiplier-markup #"1" #"1"                               %! baca.SegmentMaker._label_duration_multipliers():DURATION_MULTIPLIER
    ...
    \times 2/3 {                                                               %! harmony.sixteenths()
        ...
        ^ \baca-slate-brush-markup                                             %! baca.markup():baca.IndicatorCommand._call()
    %@% - \abjad-dashed-line-with-hook                                         %! baca.rhythm_annotation_spanner():RHYTHM_ANNOTATION_SPANNER:baca.PiecewiseCommand._call(2):SPANNER_START
    %@% - \baca-text-spanner-left-text "sixteenths([1, -3, 1, -5, 1, -7, 1, -9, 1, -11, 1, -13, 1, -15, 1, -17, 1, '-'], denominator=None, extra_counts=[2], talea_denominator=16)" %! baca.rhythm_annotation_spanner():RHYTHM_ANNOTATION_SPANNER:baca.PiecewiseCommand._call(2):SPANNER_START
    %@% - \tweak bound-details.right.padding #2.75                             %! baca.rhythm_annotation_spanner():RHYTHM_ANNOTATION_SPANNER:baca.PiecewiseCommand._call(2):AUTODETECT:SPANNER_START
    %@% - \tweak color #darkyellow                                             %! baca.rhythm_annotation_spanner():RHYTHM_ANNOTATION_SPANNER:baca.PiecewiseCommand._call(2):SPANNER_START
    %@% - \tweak staff-padding #8                                              %! baca.rhythm_annotation_spanner():RHYTHM_ANNOTATION_SPANNER:baca.PiecewiseCommand._call(2):SPANNER_START
    %@% \bacaStartTextSpanRhythmAnnotation                                     %! baca.rhythm_annotation_spanner():RHYTHM_ANNOTATION_SPANNER:baca.PiecewiseCommand._call(2):SPANNER_START
        ...
        :32                                                                    %! baca.stem_tremolo():baca.IndicatorCommand._call()
        - \tweak color #(x11-color 'DeepPink1)                                 %! REDUNDANT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
        \baca-effort-ff                                                        %! baca.hairpin():baca.PiecewiseCommand._call(2):SPANNER_STOP:baca.SegmentMaker._set_status_tag():REDUNDANT_DYNAMIC
        - \accent                                                              %! baca.accent():baca.IndicatorCommand._call()
    ...
    \times 2/3 {                                                               %! harmony.sixteenths()
        ...
        :32                                                                    %! baca.stem_tremolo():baca.IndicatorCommand._call()
        - \tweak color #(x11-color 'DeepPink1)                                 %! REDUNDANT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
        \baca-effort-f                                                         %! baca.hairpin():baca.PiecewiseCommand._call(2):SPANNER_STOP:baca.SegmentMaker._set_status_tag():REDUNDANT_DYNAMIC
        - \accent                                                              %! baca.accent():baca.IndicatorCommand._call()
...
N_Percussion_II_Music_Staff = <<                                               %! ide.Path.extern()
...
N_Harp_Music_Voice = {                                                         %! ide.Path.extern()
...
N_Harp_Music_Staff = <<                                                        %! ide.Path.extern()
...
N_Viola_Music_Voice_A = {                                                      %! ide.Path.extern()
...
N_Cello_I_Music_Voice_A = {                                                    %! ide.Path.extern()
...
N_Cello_I_Music_Voice = {                                                      %! ide.Path.extern()
...
N_Cello_I_Music_Staff = <<                                                     %! ide.Path.extern()
...
N_Cello_II_Music_Voice = {                                                     %! ide.Path.extern()
...
N_Cello_II_Music_Staff = <<                                                    %! ide.Path.extern()
...
N_Contrabass_I_Music_Voice_A = {                                               %! ide.Path.extern()
...
N_Contrabass_I_Music_Voice = {                                                 %! ide.Path.extern()
...
N_Contrabass_I_Music_Staff = <<                                                %! ide.Path.extern()
...
N_Contrabass_II_Music_Voice = {                                                %! ide.Path.extern()
...
N_Contrabass_II_Music_Staff = <<                                               %! ide.Path.extern()
