...
T_Global_Rests = {                                                             %! abjad.Path.extern()
    ...
    % [T Global_Rests measure 191 / measure 11]                                %! baca.SegmentMaker._comment_measure_numbers()
...
%%% \T_Global_Rests                                                            %! abjad.Path.extern():NOT_TOPMOST
...
%@% \override Staff.Clef.color = ##f                                           %! baca.SegmentMaker._attach_color_literal(1):EXPLICIT_CLEF_COLOR_CANCELLATION
    ...
    e4                                                                         %! harmony.sixteenths()
    \repeatTie
    \bacaStopTextSpanSCP                                                       %! baca.scp_spanner():SCP_SPANNER:baca.PiecewiseCommand._call(4):RIGHT_BROKEN:SPANNER_STOP
    \revert DynamicLineSpanner.staff-padding                                   %! baca.dls_staff_padding():baca.OverrideCommand._call(2)
%@% <> \bacaStopTextSpanRhythmAnnotation                                       %! baca.rhythm_annotation_spanner():RHYTHM_ANNOTATION_SPANNER:baca.PiecewiseCommand._call(4):SPANNER_STOP
