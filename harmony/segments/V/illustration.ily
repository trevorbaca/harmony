...
V_Bass_Flute_Music_Voice = {                                                   %! abjad.Path.extern
    ...
    \once \override Score.BarLine.transparent = ##t                            %! baca.SegmentMaker._style_fermata_measures(4):EOL_FERMATA:MEASURE_206
    \once \override Score.SpanBar.transparent = ##t                            %! baca.SegmentMaker._style_fermata_measures(4):EOL_FERMATA:MEASURE_206
    R1 * 3/4                                                                   %! baca.SegmentMaker._make_measure_silences()
