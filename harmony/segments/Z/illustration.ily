Z_Global_Skips = {                                                             %! abjad.Path.extern
    ...
    % [Z Global_Skips measure 237 / measure 1]                                 %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [Z Global_Skips measure 238 / measure 2]                                 %! _comment_measure_numbers
    s1 * 1                                                                     %! _make_global_skips(1)
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [Z Global_Skips measure 239 / measure 3]                                 %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [Z Global_Skips measure 240 / measure 4]                                 %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [Z Global_Skips measure 241 / measure 5]                                 %! _comment_measure_numbers
    \time 4/4                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca-time-signature-color #'blue                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1                                                                     %! _make_global_skips(1)
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [Z Global_Skips measure 242 / measure 6]                                 %! _comment_measure_numbers
    s1 * 1                                                                     %! _make_global_skips(1)
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER
%@% \bacaStopTextSpanCT                                                        %! CLOCK_TIME
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [Z Global_Skips measure 243 / measure 7]                                 %! _comment_measure_numbers
    s1 * 1                                                                     %! _make_global_skips(1)
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER
%@% \bacaStopTextSpanCT                                                        %! CLOCK_TIME
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [Z Global_Skips measure 244 / measure 8]                                 %! _comment_measure_numbers
    s1 * 1                                                                     %! _make_global_skips(1)
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER
    \bacaStopTextSpanSNM                                                       %! STAGE_NUMBER
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [Z Global_Skips measure 245 / measure 9]                                 %! _comment_measure_numbers
    \time 6/4                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca-time-signature-color #'blue                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 3/2                                                                   %! _make_global_skips(1)
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [Z Global_Skips measure 246 / measure 10]                                %! _comment_measure_numbers
    \time 4/4                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca-time-signature-color #'blue                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1                                                                     %! _make_global_skips(1)
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [Z Global_Skips measure 247 / measure 11]                                %! PHANTOM:_style_phantom_measures(1):_comment_measure_numbers
...
Z_Global_Rests = {                                                             %! abjad.Path.extern
    ...
    % [Z Global_Rests measure 237 / measure 1]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [Z Global_Rests measure 238 / measure 2]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)
    ...
    % [Z Global_Rests measure 240 / measure 4]                                 %! _comment_measure_numbers
    R1 * 3/2                                                                   %! _make_global_rests(1)

    % [Z Global_Rests measure 241 / measure 5]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [Z Global_Rests measure 242 / measure 6]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [Z Global_Rests measure 243 / measure 7]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [Z Global_Rests measure 244 / measure 8]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [Z Global_Rests measure 245 / measure 9]                                 %! _comment_measure_numbers
    R1 * 3/2                                                                   %! _make_global_rests(1)

    % [Z Global_Rests measure 246 / measure 10]                                %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [Z Global_Rests measure 247 / measure 11]                                %! PHANTOM:_style_phantom_measures(4):_comment_measure_numbers
...
Z_Bass_Flute_Music_Voice = {                                                   %! abjad.Path.extern
    ...
    % [Z Bass_Flute_Music_Voice measure 237 / measure 1]                       %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    % [Z Bass_Flute_Music_Voice measure 238 / measure 2]                       %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    c''4                                                                       %! harmony.sixteenths
    - \abjad-dashed-line-with-hook                                             %! COVERED:baca.covered_spanner:PiecewiseCommand(1)
    - \baca-text-spanner-left-markup \baca-cov-markup                          %! COVERED:baca.covered_spanner:PiecewiseCommand(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [Z Bass_Flute_Rest_Voice measure 239 / measure 3]                %! _comment_measure_numbers
    ...
    % [Z Bass_Flute_Music_Voice measure 242 / measure 6]                       %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    c''4                                                                       %! harmony.sixteenths
    - \abjad-dashed-line-with-hook                                             %! COVERED:baca.covered_spanner:PiecewiseCommand(1)
    - \baca-text-spanner-left-markup \baca-cov-markup                          %! COVERED:baca.covered_spanner:PiecewiseCommand(1)
    ...
    % [Z Bass_Flute_Music_Voice measure 243 / measure 7]                       %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    c''4                                                                       %! harmony.sixteenths
    - \abjad-dashed-line-with-hook                                             %! COVERED:baca.covered_spanner:PiecewiseCommand(1)
    - \baca-text-spanner-left-markup \baca-cov-markup                          %! COVERED:baca.covered_spanner:PiecewiseCommand(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [Z Bass_Flute_Music_Voice measure 244 / measure 8]               %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [Z Bass_Flute_Rest_Voice measure 244 / measure 8]                %! _comment_measure_numbers
    ...
    % [Z Bass_Flute_Music_Voice measure 245 / measure 9]                       %! _comment_measure_numbers
    R1 * 3/2                                                                   %! _make_measure_silences

    % [Z Bass_Flute_Music_Voice measure 246 / measure 10]                      %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    c''4                                                                       %! harmony.sixteenths
    - \tweak color #(x11-color 'DeepPink1)                                     %! REDUNDANT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    \mp                                                                        %! REDUNDANT_DYNAMIC:_set_status_tag:baca.dynamic:IndicatorCommand
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [Z Bass_Flute_Music_Voice measure 247 / measure 11]              %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [Z Bass_Flute_Rest_Voice measure 247 / measure 11]               %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    % [Z Percussion_I_Music_Voice measure 238 / measure 2]                     %! _comment_measure_numbers
    d'4                                                                        %! harmony.sixteenths
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [Z Percussion_I_Rest_Voice measure 239 / measure 3]              %! _comment_measure_numbers
            R1 * 1/4                                                           %! _make_multimeasure_rest_container
    ...
    % [Z Percussion_I_Music_Voice measure 242 / measure 6]                     %! _comment_measure_numbers
    d'4                                                                        %! harmony.sixteenths

    r2.                                                                        %! harmony.sixteenths

    % [Z Percussion_I_Music_Voice measure 243 / measure 7]                     %! _comment_measure_numbers
    d'4                                                                        %! harmony.sixteenths
    \revert Stem.direction                                                     %! baca.stem_down:OverrideCommand(2)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [Z Percussion_I_Music_Voice measure 244 / measure 8]             %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
            c'1 * 1                                                            %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [Z Percussion_I_Rest_Voice measure 244 / measure 8]              %! _comment_measure_numbers
            R1 * 1                                                             %! _make_multimeasure_rest_container
    ...
    % [Z Percussion_I_Music_Voice measure 245 / measure 9]                     %! _comment_measure_numbers
    R1 * 3/2                                                                   %! _make_measure_silences

    % [Z Percussion_I_Music_Voice measure 246 / measure 10]                    %! _comment_measure_numbers
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [Z Percussion_I_Music_Voice measure 247 / measure 11]            %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [Z Percussion_I_Rest_Voice measure 247 / measure 11]             %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    % [Z Percussion_II_Music_Voice measure 238 / measure 2]                    %! _comment_measure_numbers
    R1 * 4/4                                                                   %! _call_rhythm_commands
    ...
    % [Z Percussion_II_Music_Voice measure 242 / measure 6]                    %! _comment_measure_numbers
    R1 * 4/4                                                                   %! _call_rhythm_commands

    % [Z Percussion_II_Music_Voice measure 243 / measure 7]                    %! _comment_measure_numbers
    R1 * 4/4                                                                   %! _call_rhythm_commands

    % [Z Percussion_II_Music_Voice measure 244 / measure 8]                    %! _comment_measure_numbers
    \stopStaff                                                                 %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
    ...
    % [Z Percussion_II_Music_Voice measure 245 / measure 9]                    %! _comment_measure_numbers
    \stopStaff                                                                 %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
    \once \override Staff.StaffSymbol.line-count = 1                           %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
    \startStaff                                                                %! EXPLICIT_STAFF_LINES:_set_status_tag:baca.staff_lines:IndicatorCommand
    \once \override Staff.StaffSymbol.color = #(x11-color 'blue)               %! EXPLICIT_STAFF_LINES_COLOR:_attach_color_literal(2)
    ...
    % [Z Percussion_II_Music_Voice measure 246 / measure 10]                   %! _comment_measure_numbers
    R1 * 4/4                                                                   %! _call_rhythm_commands
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [Z Percussion_II_Music_Voice measure 247 / measure 11]           %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            R1 * 1/4                                                           %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [Z Percussion_II_Rest_Voice measure 247 / measure 11]            %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
Z_Harp_Music_Voice = {                                                         %! abjad.Path.extern
    ...
    % [Z Harp_Music_Voice measure 237 / measure 1]                             %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! EXPLICIT_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    % [Z Harp_Music_Voice measure 238 / measure 2]                             %! _comment_measure_numbers
    r2.                                                                        %! harmony.sixteenths
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [Z Harp_Rest_Voice measure 239 / measure 3]                      %! _comment_measure_numbers
            R1 * 1/4                                                           %! _make_multimeasure_rest_container
    ...
    % [Z Harp_Music_Voice measure 242 / measure 6]                             %! _comment_measure_numbers
    r2.                                                                        %! harmony.sixteenths
    ...
    % [Z Harp_Music_Voice measure 243 / measure 7]                             %! _comment_measure_numbers
    r2                                                                         %! harmony.sixteenths
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [Z Harp_Music_Voice measure 244 / measure 8]                     %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
            c'1 * 1                                                            %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [Z Harp_Rest_Voice measure 244 / measure 8]                      %! _comment_measure_numbers
            R1 * 1                                                             %! _make_multimeasure_rest_container
    ...
    % [Z Harp_Music_Voice measure 245 / measure 9]                             %! _comment_measure_numbers
    R1 * 3/2                                                                   %! _make_measure_silences

    % [Z Harp_Music_Voice measure 246 / measure 10]                            %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    <c'' d''>8
    - \tweak color #(x11-color 'DeepPink1)                                     %! REDUNDANT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    \f                                                                         %! REDUNDANT_DYNAMIC:_set_status_tag:baca.dynamic:IndicatorCommand
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [Z Harp_Music_Voice measure 247 / measure 11]                    %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [Z Harp_Rest_Voice measure 247 / measure 11]                     %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
Z_Viola_Music_Voice = {                                                        %! abjad.Path.extern
    ...
    % [Z Viola_Music_Voice measure 237 / measure 1]                            %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    % [Z Viola_Music_Voice measure 238 / measure 2]                            %! _comment_measure_numbers
    R1 * 4/4                                                                   %! _call_rhythm_commands
    ...
    % [Z Viola_Music_Voice measure 242 / measure 6]                            %! _comment_measure_numbers
    R1 * 4/4                                                                   %! _call_rhythm_commands

    % [Z Viola_Music_Voice measure 243 / measure 7]                            %! _comment_measure_numbers
    R1 * 4/4                                                                   %! _call_rhythm_commands

    % [Z Viola_Music_Voice measure 244 / measure 8]                            %! _comment_measure_numbers
    R1 * 4/4                                                                   %! _call_rhythm_commands

    % [Z Viola_Music_Voice measure 245 / measure 9]                            %! _comment_measure_numbers
    R1 * 6/4                                                                   %! _call_rhythm_commands

    % [Z Viola_Music_Voice measure 246 / measure 10]                           %! _comment_measure_numbers
    R1 * 4/4                                                                   %! _call_rhythm_commands
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [Z Viola_Music_Voice measure 247 / measure 11]                   %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            R1 * 1/4                                                           %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [Z Viola_Rest_Voice measure 247 / measure 11]                    %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
Z_Cello_I_Music_Voice = {                                                      %! abjad.Path.extern
    ...
    % [Z Cello_I_Music_Voice measure 237 / measure 1]                          %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    % [Z Cello_I_Music_Voice measure 238 / measure 2]                          %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    d4                                                                         %! harmony.sixteenths
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    - \tweak circled-tip ##t                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca.hairpin:PiecewiseCommand(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [Z Cello_I_Rest_Voice measure 239 / measure 3]                   %! _comment_measure_numbers
            R1 * 1/4                                                           %! _make_multimeasure_rest_container
    ...
    % [Z Cello_I_Music_Voice measure 242 / measure 6]                          %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    d4                                                                         %! harmony.sixteenths
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    - \tweak circled-tip ##t                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca.hairpin:PiecewiseCommand(1)
    ...
    % [Z Cello_I_Music_Voice measure 243 / measure 7]                          %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    d4                                                                         %! harmony.sixteenths
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    - \tweak circled-tip ##t                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca.hairpin:PiecewiseCommand(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [Z Cello_I_Music_Voice measure 244 / measure 8]                  %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
            c'1 * 1                                                            %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [Z Cello_I_Rest_Voice measure 244 / measure 8]                   %! _comment_measure_numbers
            R1 * 1                                                             %! _make_multimeasure_rest_container
    ...
    % [Z Cello_I_Music_Voice measure 245 / measure 9]                          %! _comment_measure_numbers
    R1 * 3/2                                                                   %! _make_measure_silences

    % [Z Cello_I_Music_Voice measure 246 / measure 10]                         %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    d4                                                                         %! harmony.sixteenths
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    - \tweak circled-tip ##t                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca.hairpin:PiecewiseCommand(1)
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [Z Cello_I_Music_Voice measure 247 / measure 11]                 %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [Z Cello_I_Rest_Voice measure 247 / measure 11]                  %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
Z_Cello_II_Music_Voice = {                                                     %! abjad.Path.extern
    ...
    % [Z Cello_II_Music_Voice measure 237 / measure 1]                         %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    % [Z Cello_II_Music_Voice measure 238 / measure 2]                         %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    d4                                                                         %! harmony.sixteenths
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    - \tweak circled-tip ##t                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca.hairpin:PiecewiseCommand(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [Z Cello_II_Rest_Voice measure 239 / measure 3]                  %! _comment_measure_numbers
            R1 * 1/4                                                           %! _make_multimeasure_rest_container
    ...
    % [Z Cello_II_Music_Voice measure 242 / measure 6]                         %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    d4                                                                         %! harmony.sixteenths
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    - \tweak circled-tip ##t                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca.hairpin:PiecewiseCommand(1)
    ...
    % [Z Cello_II_Music_Voice measure 243 / measure 7]                         %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    d4                                                                         %! harmony.sixteenths
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    - \tweak circled-tip ##t                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca.hairpin:PiecewiseCommand(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [Z Cello_II_Music_Voice measure 244 / measure 8]                 %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
            c'1 * 1                                                            %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [Z Cello_II_Rest_Voice measure 244 / measure 8]                  %! _comment_measure_numbers
            R1 * 1                                                             %! _make_multimeasure_rest_container
    ...
    % [Z Cello_II_Music_Voice measure 245 / measure 9]                         %! _comment_measure_numbers
    R1 * 3/2                                                                   %! _make_measure_silences

    % [Z Cello_II_Music_Voice measure 246 / measure 10]                        %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    d4                                                                         %! harmony.sixteenths
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    - \tweak circled-tip ##t                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca.hairpin:PiecewiseCommand(1)
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [Z Cello_II_Music_Voice measure 247 / measure 11]                %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [Z Cello_II_Rest_Voice measure 247 / measure 11]                 %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
Z_Contrabass_I_Music_Voice = {                                                 %! abjad.Path.extern
    ...
    % [Z Contrabass_I_Music_Voice measure 237 / measure 1]                     %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    % [Z Contrabass_I_Music_Voice measure 238 / measure 2]                     %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    d4                                                                         %! harmony.sixteenths
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    - \tweak circled-tip ##t                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca.hairpin:PiecewiseCommand(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [Z Contrabass_I_Rest_Voice measure 239 / measure 3]              %! _comment_measure_numbers
            R1 * 1/4                                                           %! _make_multimeasure_rest_container
    ...
    % [Z Contrabass_I_Music_Voice measure 242 / measure 6]                     %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    d4                                                                         %! harmony.sixteenths
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    - \tweak circled-tip ##t                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca.hairpin:PiecewiseCommand(1)
    ...
    % [Z Contrabass_I_Music_Voice measure 243 / measure 7]                     %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    d4                                                                         %! harmony.sixteenths
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    - \tweak circled-tip ##t                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca.hairpin:PiecewiseCommand(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [Z Contrabass_I_Music_Voice measure 244 / measure 8]             %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
            c''1 * 1                                                           %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [Z Contrabass_I_Rest_Voice measure 244 / measure 8]              %! _comment_measure_numbers
            R1 * 1                                                             %! _make_multimeasure_rest_container
    ...
    % [Z Contrabass_I_Music_Voice measure 245 / measure 9]                     %! _comment_measure_numbers
    R1 * 3/2                                                                   %! _make_measure_silences

    % [Z Contrabass_I_Music_Voice measure 246 / measure 10]                    %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    d4                                                                         %! harmony.sixteenths
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    - \tweak circled-tip ##t                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca.hairpin:PiecewiseCommand(1)
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [Z Contrabass_I_Music_Voice measure 247 / measure 11]            %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c''1 * 1/4                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [Z Contrabass_I_Rest_Voice measure 247 / measure 11]             %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
Z_Contrabass_II_Music_Voice = {                                                %! abjad.Path.extern
    ...
    % [Z Contrabass_II_Music_Voice measure 237 / measure 1]                    %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    % [Z Contrabass_II_Music_Voice measure 238 / measure 2]                    %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    d4                                                                         %! harmony.sixteenths
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    - \tweak circled-tip ##t                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca.hairpin:PiecewiseCommand(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [Z Contrabass_II_Rest_Voice measure 239 / measure 3]             %! _comment_measure_numbers
            R1 * 1/4                                                           %! _make_multimeasure_rest_container
    ...
    % [Z Contrabass_II_Music_Voice measure 242 / measure 6]                    %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    d4                                                                         %! harmony.sixteenths
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    - \tweak circled-tip ##t                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca.hairpin:PiecewiseCommand(1)
    ...
    % [Z Contrabass_II_Music_Voice measure 243 / measure 7]                    %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    d4                                                                         %! harmony.sixteenths
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    - \tweak circled-tip ##t                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca.hairpin:PiecewiseCommand(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [Z Contrabass_II_Music_Voice measure 244 / measure 8]            %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
            c''1 * 1                                                           %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [Z Contrabass_II_Rest_Voice measure 244 / measure 8]             %! _comment_measure_numbers
            R1 * 1                                                             %! _make_multimeasure_rest_container
    ...
    % [Z Contrabass_II_Music_Voice measure 245 / measure 9]                    %! _comment_measure_numbers
    R1 * 3/2                                                                   %! _make_measure_silences

    % [Z Contrabass_II_Music_Voice measure 246 / measure 10]                   %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    d4                                                                         %! harmony.sixteenths
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    - \tweak circled-tip ##t                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca.hairpin:PiecewiseCommand(1)
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [Z Contrabass_II_Music_Voice measure 247 / measure 11]           %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c''1 * 1/4                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [Z Contrabass_II_Rest_Voice measure 247 / measure 11]            %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
