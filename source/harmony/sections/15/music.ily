...
number.15.BassFlute.Staff = <<

    \context GlobalRests = "Rests"
    { \number.15.Rests }

    \context Voice = "BassFlute.Music"
    { \number.15.BassFlute.Music }
